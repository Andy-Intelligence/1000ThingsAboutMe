...
const ZoomingBackgroundImage: React.FC = () => {
  ...
  return (
    <div
      ...
      style={{
        ...
        backgroundPosition: '-95% 100%', // Initial background position
    ...
    >
      ...
      {/* <img className='w-full h-auto' src={RealSun3.src} alt="..."/> */}
      {/* <div>if you know you know</div> */}
    </div>
  );
};

export default ZoomingBackgroundImage;
